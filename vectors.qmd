...
![Same arrow vectors](img/vec%20same%20arrow%20vectors.png)
...
![Vector parallelogram](img/vec%20parallelogram%20of%20points.png)
...
![Vector as an arrow question](img/vec%20as%20arrow%20question.png)
...
![Vectors in a straight line](img/vec%20scalar%20multiple%20in%20line.png)
...
We can see that$\vec{OS} = \vec{OP} +$\vec{PS}$so we just need to find 
:::
